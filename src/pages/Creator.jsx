...
export default function Creator() {
  ...
  return (
    ...
    <Group noWrap spacing={0} sx={{height: '100%', overflow: 'hidden'}}>
      ...
      {!isDesktop && !menuOpen && <Button onClick={handleMenuToggle} sx={{position: 'absolute', bottom: 0, right: 0, margin: "0 20px 20px 0", borderRadius: '200px'}}><DotsThree size={32} weight="bold" /></Button>}
    </Group>
    {/* <Leva /> */}
    </>
  )
